...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "b26e7e07-2d26-46d8-8ad6-53aa22fb3d55",
  ...
  "public": {
    "NUXT_MAIL_TARGET": "bugra.keskin+website@gmail.com",
    "NUXT_MAIL_SMPT": "smtp.gmail.com",
    "NUXT_MAIL_PORT": "465",
    "NUXT_MAIL_USERNAME": "bugra.keskin@gmail.com",
    "NUXT_MAIL_PASSWORD": "vpsv uswq idqs tlfe",
...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/Users/bugrakeskin/Documents/projects/nuxt-pro/.data/kv"}));
...
const _CO3jEoRXCX = (function(nitro) {
...
const _iiWGV3 = defineCachedEventHandler(async (event) => {
...
const options = {
  "message": [
    {
      "to": "bugra.keskin+website@gmail.com"
    }
  ],
  "smtp": {
    "host": "smtp.gmail.com",
    "port": "465",
    "auth": {
      "user": "bugra.keskin@gmail.com",
      "pass": "vpsv uswq idqs tlfe"
    }
  }
};
...
const _bqwogR = defineEventHandler(async event => {
  try {
...
const _NUjiqg = defineEventHandler((e) => {
...
const _eaLDGc = defineEventHandler(async (e) => {
  ...
  const { indexable: _indexable, _context } = useSiteConfig(e, { debug: false });
...
const _E5SeIY = defineEventHandler((e) => {
...
const _lazy_MKzQeo = () => import('../routes/renderer.mjs');

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_MKzQeo, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _iiWGV3, lazy: false, middleware: false, method: undefined },
  { route: '/mail/send', handler: _bqwogR, lazy: false, middleware: false, method: "post" },
  { route: '', handler: _NUjiqg, lazy: false, middleware: true, method: undefined },
  { route: '/robots.txt', handler: _eaLDGc, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _E5SeIY, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_MKzQeo, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, toRouteMatcher as A, createRouter$1 as B, withHttps as C, listener as D, getRouteRules as a, buildAssetsURL as b, createError$1 as c, defineRenderHandler as d, getResponseStatus as e, getResponseStatusText as f, getQuery as g, useNitroApp as h, baseURL as i, defu as j, defuFn as k, klona as l, createDefu as m, parseQuery as n, isEqual as o, publicAssetsURL as p, getContext as q, createHooks as r, hasProtocol as s, joinURL as t, useRuntimeConfig as u, isScriptProtocol as v, withQuery as w, sanitizeStatusCode as x, withTrailingSlash as y, withoutTrailingSlash as z };
