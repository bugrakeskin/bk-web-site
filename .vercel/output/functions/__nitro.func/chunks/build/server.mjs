import { version, ref, watchEffect, watch, getCurrentInstance, toRef, isRef, defineAsyncComponent, defineComponent, h, inject, computed, unref, provide, shallowReactive, Suspense, nextTick, Fragment, Transition, useSSRContext, useAttrs, toValue, hasInjectionContext, mergeProps, onServerPrefetch, resolveComponent, createVNode, resolveDynamicComponent, withCtx, renderSlot, openBlock, createBlock, createCommentVNode, toDisplayString, createApp, effectScope, reactive, getCurrentScope, shallowRef, onErrorCaptured, isReadonly, createSlots, renderList, isShallow, isReactive, toRaw } from 'vue';
import { $ as $fetch$1, i as baseURL, j as defu, k as defuFn, l as klona, m as createDefu, n as parseQuery, o as isEqual, q as getContext, r as createHooks, c as createError$1, s as hasProtocol, t as joinURL, v as isScriptProtocol, w as withQuery, x as sanitizeStatusCode, y as withTrailingSlash, z as withoutTrailingSlash, A as toRouteMatcher, B as createRouter$1, C as withHttps } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "about",
    path: "/about",
    component: () => import('./about-DZ-iiskg.mjs')
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import('./contact-DL-F0GW2.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-BIup_skg.mjs')
  },
  {
    name: "projects",
    path: "/projects",
    component: () => import('./projects-DBJknSBA.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-BESor-Xq.mjs'))
};
  ...
  setup(__props) {
    ...
    useHead({
      ...
      link: [
        ...
        { rel: "canonical", href: config2.public.siteUrl }
      ],
      script: [
        {
    ...
    useSeoMeta({
      ...
      ogImage: `${config2.public.siteUrl}/og-image.png`,
      ogUrl: config2.public.siteUrl,
      ogType: "website",
      ...
      twitterImage: `${config2.public.siteUrl}/og-image.png`,
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DPES49bw.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-R_QV53ai.mjs'));
...
export { _export_sfc as _, __nuxt_component_0$1 as a, __nuxt_component_2$1 as b, appConfig as c, useUI as d, entry$1 as default, useInjectButtonGroup as e, useNuxtApp as f, useToast as g, __nuxt_component_1 as h, input as i, __nuxt_component_5 as j, useState as k, looseToNumber as l, mergeConfig as m, useAppConfig as n, textarea as t, useHead as u };
