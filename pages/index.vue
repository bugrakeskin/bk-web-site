<template>
  <div class="min-h-[calc(100vh-18rem)] p-4 md:p-2 mt-24 md:mt-0 flex items-center justify-center">
    <div class="max-w-3xl text-center">
      <h1 class="text-4xl font-bold mb-6 text-center text-gray-900 dark:text-white">DevOps Engineer & Jr. Full Stack Developer</h1>
